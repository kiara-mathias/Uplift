...
export default function Home() {
  ...
  const focusAreas = [
    ...
    { label: 'Nutrition', route: '/nutrition/nutrition-home', icon: 'restaurant', colors: ['#3CB371', '#a8e063'] },
    { label: 'Well-being', route: '/well-being/well-being', icon: 'self-improvement', colors: ['#6A5ACD', '#b39ddb'] },
